...
public class ApplyLabTestThirdDTO implements Serializable {
    ...
    /**
     * 字段描述: 本人电话号码(长度:50)
     * 字段定义: 本人联系电话的号码，包括国际、国内区号和分机号
     * 国标字段: DE02.01.010.00
     */
    @JsonProperty("WS02_01_010_01")
     ...
     * 规则: 报告单未产生时非必填，报告单生成后要求必填且与报告单一同上传
     * 国标字段: DE01.00.018.00
     */
     ...
     * 字段定义: 院内申请科室代码
     */
    @JsonProperty("WS99_99_902_95")
    private String campusApplyDeptId;

    /**
     * 字段描述: 院内申请科室名称(长度:100)
     * 字段定义: 院内申请科室名称
     */
    @JsonProperty("CT99_99_902_95")
    private String campusApplyDeptName;
