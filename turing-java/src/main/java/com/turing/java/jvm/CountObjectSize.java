 ...
 * markword ( 32位 4 byte ---64位 8 byte)
...
public class CountObjectSize {
    ...
    public static void main(String[] args) {
        ...
        //空Object 开启指针压缩:  markword 8bytes + class 地址 4bytes + 成员变量 0bytes + 对齐填充 4bytes = 16bytes
        //空Object 关闭指针压缩:  markword 8bytes + class 地址 8bytes + 成员变量 0bytes + 对齐填充 0bytes = 16bytes
